...
//Función donde dibujamos la grafica de la cotangente desde -3PI hasta 3PI
void cotangente(void)
{ 
	
	float x, y;
   
   //condición que va desde -3PI hasta 3PI incrementando en 0.0011
    for (x=-3*M_PI; x<3*M_PI; x+=0.0011)
    {
...
void display(void)
{
    ...
    cotangente(); //Llama a la función de cotangente para mostrar la grafica
